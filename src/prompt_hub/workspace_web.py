...
<section class="dataset-page" id="workspacePage" hidden>
  ...
  <dialog id="datasetDetail" class="dataset-dialog">
    ...
    <div class="dataset-dialog-body">
      ...
      <div class="dataset-action-row"><button id="datasetDetailKrea2Revise">按修正意见改写草稿</button><span id="datasetDetailKrea2ReviseStatus" class="dataset-hint">改写会覆盖上方英文草稿。确认前都还能改。</span></div>
