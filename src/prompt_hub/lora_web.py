...
<style>
  ...
  .lora-journey button { min-width: 0; border: 0; background: #d8d1c2; padding: 11px 8px; color: var(--ink); text-align: left; cursor: pointer; }
...
<script>
(() => {
  const state = {projects:[], active:null, options:null, workspaces:[], oc:[], sourceReport:null, sourceImages:[], sourceSelected:new Set(), sourcePage:1, sourcePageSize:12, coveragePreview:null, step:1, assetPage:1, assetPageSize:12};
